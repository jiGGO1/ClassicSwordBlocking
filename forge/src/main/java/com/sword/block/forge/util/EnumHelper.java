...
package com.sword.block.forge.util;
...
public class EnumHelper {
    ...
    private static void setup() {
        ...
        try {
            ...
            SwordBlock.LOGGER.error("Error setting up EnumHelper.", e);
        }
    ...
    @Nullable
    public static UseAnim addAction(String name)
    {
        return addEnum(UseAnim.class, name);
    }
    ...
    private static <T extends Enum<?>> T addEnum(boolean test, final Class<T> enumType, @Nullable String enumName, final Class<?>[] paramTypes, @Nullable Object[] paramValues) {
        ...
        int flags = (RUNTIME_DEOBF ? Modifier.PUBLIC : Modifier.PRIVATE) | Modifier.STATIC | Modifier.FINAL | 0x1000 /*SYNTHETIC*/;
        if (valuesField == null) {
        ...
        if (valuesField == null) {
            ...
            lines.add(String.format("Runtime Deobf: %s", RUNTIME_DEOBF));
        ...
        try {
            ...
            SwordBlock.LOGGER.error("Error adding enum with EnumHelper.", e);
